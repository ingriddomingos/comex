...
public class ProdutoIsento extends Produto {
	...
	public ProdutoIsento(long id, String nome, String descricao, double precoUnitario, float quantidadeEstoque,
	...
	public ProdutoIsento(String nome, double precoUnitario, float quantidadeEstoque, String categoriaProduto) {
		if (nome == null) {
